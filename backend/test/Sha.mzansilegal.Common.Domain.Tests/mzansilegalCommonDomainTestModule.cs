...
using Sha.mzansilegal.Tests.DependencyInjection;
using Shesha;
...
namespace Sha.mzansilegal.Common.Tests
{
    [DependsOn(
    ...
    public class mzansilegalCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public mzansilegalCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
