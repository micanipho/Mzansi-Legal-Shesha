...
using Sha.mzansilegal.Hangfire;
using Shesha;
...
namespace Sha.mzansilegal.Web.Host.Startup
{
		...
		public void Configure(IApplicationBuilder app, IBackgroundJobClient backgroundJobs)
		{
			...
			app.UseSwaggerUI(options =>
			{
				...
				options.IndexStream = () => Assembly.GetExecutingAssembly()
					.GetManifestResourceStream("Sha.mzansilegal.Web.Host.wwwroot.swagger.ui.index.html");
			}); // URL: /swagger​
