...
using Sha.mzansilegal.Application;
...
namespace Sha.mzansilegal
{
    /// <summary>
    /// ReSharper disable once InconsistentNaming
    /// </summary>
    [DependsOn(
        // Adding all the mzansilegal Modules
        ...
        typeof(mzansilegalApplicationModule)
	 )]
    public class mzansilegalWebCoreModule : AbpModule
    {
        ...
        public mzansilegalWebCoreModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(mzansilegalWebCoreModule).GetAssembly());
        }
    }
}
